...
void PART4_init__(PART4 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->BROKEN,__BOOL_LITERAL(FALSE),retain)
...
void PART4_body__(PART4 *data__) {
  ...
  __SET_VAR(data__->R_TRIG1.,CLK,,__GET_VAR(data__->CAR_ENTERING,));
  R_TRIG_body__(&data__->R_TRIG1);
  __SET_VAR(data__->R_TRIG2.,CLK,,__GET_VAR(data__->R_TRIG1.Q,));
  R_TRIG_body__(&data__->R_TRIG2);
  __SET_VAR(data__->R_TRIG3.,CLK,,__GET_VAR(data__->CAR_EXITING,));
  R_TRIG_body__(&data__->R_TRIG3);
  __SET_VAR(data__->R_TRIG4.,CLK,,__GET_VAR(data__->R_TRIG3.Q,));
  R_TRIG_body__(&data__->R_TRIG4);
  __SET_VAR(data__->TP0.,IN,,!(__GET_VAR(data__->SYSTEM_OFF,)));
  __SET_VAR(data__->TP0.,PT,,__time_to_timespec(1, 50, 0, 0, 0, 0));
  TP_body__(&data__->TP0);
  __SET_VAR(data__->CTUD0.,CU,,__GET_VAR(data__->R_TRIG2.Q,));
  __SET_VAR(data__->CTUD0.,CD,,__GET_VAR(data__->R_TRIG4.Q,));
  __SET_VAR(data__->CTUD0.,R,,__GET_VAR(data__->TP0.Q,));
  __SET_VAR(data__->CTUD0.,PV,,4);
  CTUD_body__(&data__->CTUD0);
  if (__GET_VAR(data__->CTUD0.QU,)) {
    __SET_VAR(data__->,BROKEN,,__BOOL_LITERAL(TRUE));
  };
  ...
  __SET_VAR(data__->,GREEN_ENTR_LIGHT,,((!(__GET_VAR(data__->SYSTEM_OFF,)) && __GET_VAR(data__->NO_CARS,)) && !(__GET_VAR(data__->BROKEN,))));
  __SET_VAR(data__->,GREEP_PKG_LIGHT,,((!(__GET_VAR(data__->SYSTEM_OFF,)) && __GET_VAR(data__->NO_CARS,)) && !(__GET_VAR(data__->BROKEN,))));
  __SET_VAR(data__->,RED_ENTR_LIGHT,,!((__GET_VAR(data__->NO_CARS,) && !(__GET_VAR(data__->BROKEN,)))));
  __SET_VAR(data__->,RED_PKG_LIGHT,,!((__GET_VAR(data__->NO_CARS,) && !(__GET_VAR(data__->BROKEN,)))));
  __SET_VAR(data__->,_TMP_MOVE11_OUT,,__PART4_MOVE__UINT__UINT4(
    (BOOL)((__GET_VAR(data__->CAR_SENSOR_1,) && __GET_VAR(data__->NO_CARS,)) && !(__GET_VAR(data__->BROKEN,))),
  ...
  __SET_VAR(data__->,_TMP_MOVE19_OUT,,__PART4_MOVE__UINT__UINT6(
    (BOOL)((__GET_VAR(data__->CAR_SENSOR_2,) && __GET_VAR(data__->NO_CARS,)) && !(__GET_VAR(data__->BROKEN,))),
