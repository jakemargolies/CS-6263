...
void PART3_init__(PART3 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->WAITING_FOR_REQUEST,0,retain)
  __INIT_VAR(data__->WAITING_FOR_TRAFFIC,0,retain)
  __INIT_VAR(data__->SLOWING_CARS,0,retain)
  __INIT_VAR(data__->PEDS_XING,0,retain)
  __INIT_VAR(data__->TURNING_ALL_RED,0,retain)
...
void PART3_body__(PART3 *data__) {
  ...
  __SET_VAR(data__->,CAR_GREEN,,(__GET_VAR(data__->WAITING_FOR_REQUEST,) || __GET_VAR(data__->WAITING_FOR_TRAFFIC,)));
  __SET_VAR(data__->,_TMP_EQ1_OUT,,__PART3_EQ__BOOL__UINT1(
    ...
    data__));
  __SET_VAR(data__->,WAITING_FOR_REQUEST,,__GET_VAR(data__->_TMP_EQ1_OUT,));
  ...
  __SET_VAR(data__->,PED_GREEN,,__GET_VAR(data__->PEDS_XING,));
  __SET_VAR(data__->,PED_RED,,!(__GET_VAR(data__->PEDS_XING,)));
  __SET_VAR(data__->,_TMP_EQ4_OUT,,__PART3_EQ__BOOL__UINT3(
    ...
    (UINT)__GET_VAR(data__->WAIT_FOR_TRAFFIC,),
    data__));
  __SET_VAR(data__->,WAITING_FOR_TRAFFIC,,__GET_VAR(data__->_TMP_EQ4_OUT,));
  ...
  __SET_VAR(data__->,CAR_RED,,(__GET_VAR(data__->PEDS_XING,) || __GET_VAR(data__->TURNING_ALL_RED,)));
  __SET_VAR(data__->,CAR_YELLOW,,__GET_VAR(data__->SLOWING_CARS,));
  __SET_VAR(data__->,_TMP_EQ7_OUT,,__PART3_EQ__BOOL__UINT5(
    ...
    (UINT)__GET_VAR(data__->SLOW_CARS,),
    data__));
  __SET_VAR(data__->,SLOWING_CARS,,__GET_VAR(data__->_TMP_EQ7_OUT,));
  ...
  __SET_VAR(data__->,_TMP_EQ10_OUT,,__PART3_EQ__BOOL__UINT7(
    ...
    (UINT)__GET_VAR(data__->PED_XING,),
    data__));
  __SET_VAR(data__->,PEDS_XING,,__GET_VAR(data__->_TMP_EQ10_OUT,));
  ...
  __SET_VAR(data__->,_TMP_EQ13_OUT,,__PART3_EQ__BOOL__UINT9(
    ...
    (UINT)__GET_VAR(data__->ALL_RED,),
    data__));
  __SET_VAR(data__->,TURNING_ALL_RED,,__GET_VAR(data__->_TMP_EQ13_OUT,));
