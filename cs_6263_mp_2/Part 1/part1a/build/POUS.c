...
void PART_1A_init__(PART_1A *data__, BOOL retain) {
...
// Code part
void PART_1A_body__(PART_1A *data__) {
  // Initialise TEMP variables

  __SET_VAR(data__->,NOT14_OUT,,!(__GET_VAR(data__->OUTPUT0,)));
  __SET_VAR(data__->,AND13_OUT,,AND__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)__GET_VAR(data__->NOT14_OUT,),
    (BOOL)__GET_VAR(data__->INPUT0,)));
  __SET_VAR(data__->TP0.,IN,,__GET_VAR(data__->AND13_OUT,));
  __SET_VAR(data__->TP0.,PT,,__time_to_timespec(1, 0, 6, 0, 0, 0));
  TP_body__(&data__->TP0);
  __SET_VAR(data__->,OUTPUT0,,__GET_VAR(data__->TP0.Q,));
